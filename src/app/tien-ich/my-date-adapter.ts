...
const DEFAULT_MONTH_NAMES = {
  'long': [
    'Tháng 1', 'Tháng 2', 'Tháng 3', 'Tháng 4', 'Tháng 5', 'Tháng 6', 'Tháng 7', 'Tháng 8', 'Tháng 9',
    'Tháng 10', 'Tháng 11', 'Tháng 12'
  ],
  'short': ['Th.1', 'Th.2', 'Th.3', 'Th.4', 'Th.5', 'Th.6', 'Th.7', 'Th.8', 'Th.9', 'Th.10', 'Th.11', 'Th.12'],
  'narrow': ['M', 'H', 'B', 'B', 'N', 'S', 'B', 'T', 'C', 'M', 'M', 'H']
};
...
const DEFAULT_DAY_OF_WEEK_NAMES = {
  'long': ['Chủ nhật', 'Thứ hai', 'Thứ ba', 'Thứ tư', 'Thứ năm', 'Thứ sau', 'Thứ 7'],
...
export class MyDateAdapter extends DateAdapter<Date> {
  ...
  format(date: Date, displayFormat: Object): string {
    ...
    */
    ...
    return ("0" + ngay).slice(-2) + "/" + ("0" + thang).slice(-2) + "/" + nam;
  }
