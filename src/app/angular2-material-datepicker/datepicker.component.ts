import {
  forwardRef, Component, ElementRef, EventEmitter, Input, OnChanges, OnInit, Output, Renderer, SimpleChange
} from '@angular/core';
...
const MATERIAL_DATE_PICKER_CONTROL_VALUE_ACCESSOR: any = {
...
@Component({
  ...
  providers: [MATERIAL_DATE_PICKER_CONTROL_VALUE_ACCESSOR],
  animations: [
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <span *ngIf="day != 0" [style.opacity]="((!rangeStart || day.getTime() >= rangeStart.getTime())) ? '1' : '0.3'">
                <span >
                  {{ day.getDate() }}
                </span>
              </span>
...
export class DatepickerComponent implements OnInit, OnChanges, ControlValueAccessor {
  ...
  onSelectDay(day: Date): void {
    if (!this.rangeStart || day.getTime() >= this.rangeStart.getTime()) {
      this.date = day;
